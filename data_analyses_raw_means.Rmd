...
```{r corrplot1, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Correlation plot of traits averaged across environments"), echo=FALSE}
knitr::include_graphics("./figures/Fig4_corrplot_over_env.pdf")
```

```{r corrplot2, out.width="1\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Correlation plot of traits averaged within each environments"), echo=FALSE}
knitr::include_graphics("./figures/Fig5_corrplot_p-adjust_all.pdf")
```
